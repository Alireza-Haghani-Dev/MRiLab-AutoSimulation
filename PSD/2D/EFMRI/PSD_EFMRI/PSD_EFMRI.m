...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_EFMRI
global VCtl
global VVar
CV1=10e-3;
CV10=0;
...
[rfAmp1,rfPhase1,rfFreq1,rfCoil1,rfTime1]=rfRect(p);
...
[rfAmp2,rfPhase2,rfFreq2,rfCoil2,rfTime2]=rfRect(p);
if strcmp(VCtl.MultiTransmit,'off')
